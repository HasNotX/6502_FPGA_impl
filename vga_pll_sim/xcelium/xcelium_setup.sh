...
# ACDS 25.1 1129 linux 2026.04.16.18:48:51
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/someone/altera_lite/25.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vga_pll.vo"
fi
