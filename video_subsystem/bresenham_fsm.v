module bresenham_fsm (
    input  wire        clk,
    input  wire        reset,
    input  wire        draw_req,      // KEY[0]
    input  wire [5:0]  radius_in,     // User defined radius
    input  wire [2:0]  color_in,      // User defined color
    ...
    assign fsm_state_out = current_state; // Export to top level
    ...
    // Synchronous Datapath Registers
    always @(posedge clk) begin
        ...
        // Fixed Signed Contagion Bug (Removed 16'd unsigned literals)
