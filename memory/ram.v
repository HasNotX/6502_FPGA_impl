...
module ram (
    ...
    initial begin
        ...
        // $801C: Write Nametable Tiles (A hardware loop!)
        mem[16'h801C] = 8'hA9; mem[16'h801D] = 8'h21;                        // LDA #$21
        mem[16'h801E] = 8'h8D; mem[16'h801F] = 8'h06; mem[16'h8020] = 8'h20; // STA $2006
        mem[16'h8021] = 8'hA9; mem[16'h8022] = 8'hE8;                        // LDA #$E8 (Center Left)
        mem[16'h8023] = 8'h8D; mem[16'h8024] = 8'h06; mem[16'h8025] = 8'h20; // STA $2006
        
        mem[16'h8026] = 8'hA2; mem[16'h8027] = 8'h10;                        // LDX #$10 (Loop 16 times)
        mem[16'h8028] = 8'hA9; mem[16'h8029] = 8'h01;                        // LDA #$01 (Tile ID 1)
        mem[16'h802A] = 8'h8D; mem[16'h802B] = 8'h07; mem[16'h802C] = 8'h20; // STA $2007 (Loop Start $802A)
        mem[16'h802D] = 8'hCA;                                               // DEX
        mem[16'h802E] = 8'hD0; mem[16'h802F] = 8'hFA;                        // BNE $802A (Branch back 6 bytes)

        // $8030: Set Scroll to 0,0
        mem[16'h8030] = 8'hA9; mem[16'h8031] = 8'h00;                        // LDA #$00
        mem[16'h8032] = 8'h8D; mem[16'h8033] = 8'h05; mem[16'h8034] = 8'h20; // STA $2005
        mem[16'h8035] = 8'h8D; mem[16'h8036] = 8'h05; mem[16'h8037] = 8'h20; // STA $2005

        // $8038: Enable Background: PPUMASK = $0A
        mem[16'h8038] = 8'hA9; mem[16'h8039] = 8'h0A;                        // LDA #$0A
        mem[16'h803A] = 8'h8D; mem[16'h803B] = 8'h01; mem[16'h803C] = 8'h20; // STA $2001

        // $803D: Infinite Loop
        mem[16'h803D] = 8'h4C; mem[16'h803E] = 8'h3D; mem[16'h803F] = 8'h80; // JMP $803D
    end
